...
export class ExcluirComponent {
  ...
  constructor(
    ...
    this.enderecoMap = this.sanitizer.bypassSecurityTrustResourceUrl("https://www.google.com/maps/embed/v1/place?q=" + this.enderecoCompleto() + "&key=AIzaSyAP0WKpL7uTRHGWyakgQXbW6FUhrrA5pE");
